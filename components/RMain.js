...
<div className="bg-white p-2 max-w-3xl sm:w-full sm:p-4 h-auto sm:h-64 rounded-2xl shadow-lg flex flex-col sm:flex-row gap-5 select-none">
    <div className="relative h-52 sm:h-full sm:w-72 rounded-xl bg-gray-100 bg-center bg-cover">
        <Image src={post.featuredImage.node.sourceUrl} layout="fill" />
    </div>
