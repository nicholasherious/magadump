...
<div className="p-4 bg-white mb-4 shadow-xl max-w-4xl rounded-xl flex justify-start dark:bg-gray-800 md:flex-row flex-col gap-4">
  <div className="md:w-52 md:h-36">
    <div className="relative">
        <img src={post.image} className="object-cover rounded-xl w-full h-60 md:w-full md:h-36"/>
        ...
        <div className="flex items-start my-2 md:m-0">
            <div className="relative">
                <a href="#" className="block relative">
                    <img alt="profil" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" className="mx-auto object-cover rounded-full h-10 w-10 "/>
                </a>
                <svg width="10" height="10" fill="currentColor" className="fill-current text-white bg-blue-600 rounded-full p-1 absolute bottom-0 right-0 w-4 h-4 -mx-1 -my-1" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col items-start justify-center ml-2">
                ...
                <Link href={`/user/${post.userData}`}><a> {post.name}</a></Link>
