...
export default function UserProfile({ user }) {
  return (
    <div className='p-6 sm:p-12 bg-coolGray-50 text-coolGray-800'>
      <div className='flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row'>
        <img
          src='https://source.unsplash.com/75x75/?portrait'
          alt=''
          className='self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start bg-coolGray-500 border-coolGray-300'
        />
